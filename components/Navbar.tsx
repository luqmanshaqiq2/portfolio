...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    'overlay fixed inset-0 z-[2] bg-black/30 backdrop-blur-sm transition-all duration-150',
                    {
            ...
            <div
                className={cn(
                    'fixed top-0 right-0 h-[100dvh] w-screen max-w-none transform translate-x-full transition-transform duration-700 z-[3] overflow-hidden gap-y-14',
            ...
            >
                <div
                    className={cn(
                        'absolute inset-0 bg-white/10 backdrop-blur-md border-l border-white/10 duration-700 delay-150 z-[-1]',
                        {
                            'translate-x-0': isMenuOpen,
                        },
                    )}
