...
export const PROJECTS: IProject[] = [
    {
      ...
      Full-Stack Developer <br/>
       Contributed across the complete development lifecycle:
      <ul>
        ...
        <li>🎨 Frontend: Built responsive interfaces using React.js</li>
        ...
        <li>🐳 Deployment: Containerized the application using Docker</li>
      </ul>
      `,
        techStack: ['React.js', 'MySQL', 'Docker', 'Express.js'],
    ...
    - Developed the backend using ASP.NET Core with a structured API architecture.<br/>
    - Integrated Mapbox GL for interactive maps, location search, and destination exploration.<br/>
    - Integrated weather data to provide location-specific weather information.<br/>    
    - Implemented a safety scoring system to help users assess the safety of different locations.<br/>
    - Developed a <b>JSON-based</b> etiquette and cultural guidance feature that reads and suggests recommendations for international travellers.<br/>
    - Implemented JWT-based authentication and authorization.<br/>
    - Built an admin reporting system for reviewing and managing submitted reports.<br/>`,
    },
    {
        title: 'Cliniq API',
        slug: 'cliniq',
        ...
        role: `As the sole developer, I:<br/>
    - Designed and built the full API architecture, including the Patient, Doctor, Appointment, MedicalRecord, and billing (Invoice/Payment) data model.<br/>
    - Implemented appointment scheduling with availability slot management, resolving UTC/local time conversion and double-booking edge cases.<br/>
    - Added Redis caching to reduce database load on frequently accessed endpoints.<br/>
    - Enforced business rules through FluentValidation and structured the codebase with clean service/repository separation, Swagger documentation, and middleware for rate limiting and error handling.`,
    },
    {
        ...
        role: `As the sole developer, I:<br/>
        - Implemented a custom ASP.NET Core middleware to act as a privacy boundary for API requests and responses.<br/>
        - Used DTOs to control what data crosses the API boundary.<br/>
        - Added validation and authorization to protect endpoints.<br/>
        - Considered security, data exposure, and failure points when designing the request flow.`,
    },
];
